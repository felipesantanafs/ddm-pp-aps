...
def create_funil_violencia():
    # Caminhos
    sinan_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'dados', 'sinan_cnes_merged.csv'))
    sim_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'dados', 'sim_feminicidios_sp.csv'))
    ...
    funil_csv_path = os.path.join(os.path.dirname(__file__), '..', 'dados', 'funil_violencia_ano.csv')
